                    ...
                    {history.length === 0 ? (
                        ...
                        [...history].reverse().map((sql, i) => (
                            <div 
                                ...
                                className="group relative bg-black/40 border border-white/5 rounded-lg p-4 hover:border-terminal-blue/30 hover:bg-white/5 transition-all cursor-pointer"
                            >
